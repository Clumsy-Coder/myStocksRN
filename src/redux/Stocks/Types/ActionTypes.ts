enum ActionTypes {
  ...
  FETCH_SYMBOLS_METADATA = 'STOCKS/FETCH_SYMBOLS_METADATA',
  FETCH_SYMBOLS_METADATA_PENDING = 'STOCKS/FETCH_SYMBOLS_METADATA_PENDING',
  FETCH_SYMBOLS_METADATA_FULFILLED = 'STOCKS/FETCH_SYMBOLS_METADATA_FULFILLED',
  FETCH_SYMBOLS_METADATA_REJECTED = 'STOCKS/FETCH_SYMBOLS_METADATA_REJECTED',
